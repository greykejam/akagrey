            ...
            <div class="row">
                <div class="menu-header">
                    <div class="col-md-6 col-xs-6">
                        <div class="headline-font title-med white-text">DIY</div>
                    </div>
                    <div class="col-md-6 col-xs-6">
                    ...
                    <div class="tab-style1">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <ul class="nav nav-tabs nav-tabs-light text-center image-tab">
                                    <li class="active menu-thumb-buffet"><a href="#tab_sec1" data-toggle="tab"><p>RED BUFFET</p><img src="images/2025/diy/button_diy_red_225x90_01.png" alt=""></a></li>
                                    <li class="menu-thumb-buffet"><a href="#tab_sec2" data-toggle="tab"><p>SILVER BUFFET</p><img src="images/2025/diy/button_diy_silver_225x90_02.png" alt=""></a></li>
                                    <li class="menu-thumb-buffet"><a href="#tab_sec3" data-toggle="tab"><p>GOLD BUFFET</p><img src="images/2025/diy/button_diy_gold_225x90_03.png" alt=""></a></li>
                                    <li class="menu-thumb-buffet"><a href="#tab_sec4" data-toggle="tab"><p>PLATINUM BUFFET</p><img src="images/2025/diy/button_diy_platinum_225x90_04.png" alt=""></a></li>
                                </ul>
                                <!-- tab end navigation -->
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane med-text fade in active" id="tab_sec1">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet399-desktop">
                                        <img src="images/2025/diy/WEB_DIY_RED.jpg" alt="">
                                    </div>
                                    <div class="col-md-12 text-center buffet399-mobile">
                                        <img src="images/2025/diy/MOBLIE_DIY_RED.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
                            ...
                            <div class="tab-pane fade in" id="tab_sec2">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet499-desktop">
                                        <img src="images/2025/diy/WEB_DIY_SILVER.jpg" alt="">
                                    </div>
                                    <div class="col-md-12 text-center buffet499-mobile">
                                        <img src="images/2025/diy/MOBLIE_DIY_SILVER.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
                            ...
                            <div class="tab-pane fade in" id="tab_sec3">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet499-desktop">
                                        <img src="images/2025/diy/WEB_DIY_GOLD.jpg" alt="">
                                    </div>
                                    <div class="col-md-12 text-center buffet499-mobile">
                                        <img src="images/2025/diy/MOBLIE_DIY_GOLD.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
                            ...
                            <div class="tab-pane fade in" id="tab_sec4">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet499-desktop">
                                        <img src="images/2025/diy/WEB_DIY_PLATINUM.jpg" alt="">
                                    </div>
                                    <div class="col-md-12 text-center buffet499-mobile">
                                        <img src="images/2025/diy/MOBLIE_DIY_PLATINUM.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
