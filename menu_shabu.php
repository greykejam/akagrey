...
<body style="background-image:url('images/aka/main/bg-main.jpg'); background-size: cover; background-position: 0 0;">
    ...
    <!-- slider -->
    <section class="content-top-margin page-title parallax parallax-fix" style="background: url('img_shabu/banner_shabu.jpg') 50% 0; margin-top: -20px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <!-- page title -->
                    <p class="white-text font-40 sub-title animated fadeInDown">à¸šà¸¸à¸Ÿà¹€à¸Ÿà¹ˆà¸•à¹Œà¸Šà¸²à¸šà¸¹ à¸­à¸´à¹ˆà¸¡à¸ˆà¸¸à¸ à¸ªà¸™à¸¸à¸à¸—à¸¸à¸à¹‚à¸¡à¹€à¸¡à¸™à¸—à¹Œ</p>
                    <!-- end page title -->
                    <!-- page title tagline -->
                    <p class="white-text headline-font font-50 animated fadeInUp">AKA SHABU</p>
                    <!-- end title tagline -->
                </div>
            </div>
        </div>
            ...
            <div class="row menu-header">
                <div class="col-md-5 col-xs-5">
                    <div class="headline-font title-med gray-text">
                        <a href="menu_buffet.php">AKA YAKINIKU</a>
                    </div>
                </div>
                ...
                <div class="col-md-5 col-xs-5">
                    <div class="headline-font title-med white-text">AKA SHABU</div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-style1">
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-light text-center image-tab">
                                        <li class="menu-thumb-buffet"><a href="#tab_sec1" data-toggle="tab"><p>MEAT LOVER</p><img src="img_shabu/tab_3.png" alt=""></a></li>
                                        <li class="menu-thumb-buffet"><a href="#tab_sec2" data-toggle="tab"><p>REGULAR</p><img src="img_shabu/tab_2.png" alt=""></a></li>
                                        <li class="menu-thumb-buffet"><a href="#tab_sec3" data-toggle="tab"><p>PREMIUM</p><img src="img_shabu/tab_1.png" alt=""></a></li>
                                    </ul>
                                    <!-- tab end navigation -->
                                </div>
                            </div>
                            ...
                            <div class="tab-content">
                                <!-- tab content -->
                                <div class="tab-pane med-text fade in active" id="tab_main">
                                    <div class="row">
                                        <div class="col-md-7 text-center">
                                            <video width="100%" loop="true" autoplay="autoplay" controls muted>
                                                <source src="img_shabu/shabu_video.mp4" type="video/mp4">
                                            </video>
                                        </div>
                                        <div class="col-md-5 text-center">
                                            <div style="padding-bottom: 50px; padding-top: 50px;">
                                                <img src="img_shabu/icons.png" alt="">
                                            </div>
                                            <div>
                                                <img src="img_shabu/shabu_info.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane med-text fade in" id="tab_sec1">
                                    <div class="row">
                                        <div class="col-md-12 text-center buffet399-desktop">
                                            <img src="img_shabu/Desktop-lover.jpg" alt="">
                                        </div>
                                        <div class="col-md-12 text-center buffet399-mobile">
                                            <img src="img_shabu/mobile-lover.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                                <!-- end tab content -->
                                ...
                                <div class="tab-pane fade in" id="tab_sec2">
                                    <div class="row">
                                        <div class="col-md-12 text-center buffet499-desktop">
                                            <img src="img_shabu/Desktop-regular.jpg" alt="">
                                        </div>
                                        <div class="col-md-12 text-center buffet499-mobile">
                                            <img src="img_shabu/mobile-regular.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                                <!-- end tab content -->
                                ...
                                <div class="tab-pane fade in" id="tab_sec3">
                                    <div class="row">
                                        <div class="col-md-12 text-center buffet499-desktop">
                                            <img src="img_shabu/Desktop-PREMIUM.jpg" alt="">
                                        </div>
                                        <div class="col-md-12 text-center buffet499-mobile">
                                            <img src="img_shabu/mobile-PREMIUM.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                                <!-- end tab content -->
