...
<body style="background-image:url('images/aka/main/bg-main.jpg'); background-size: cover; background-position: 0 0;">
    ...
    <section class="position-relative">
        ...
        <div class="bg-banner-bottom">
            <img src="images/aka/main/bg-banner-bottom.png" alt="" loading="lazy">
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="menu-header">
                    ...
                    <div class="col-md-4 col-xs-4">
                        <div class="headline-font title-med gray-text">
                            <a href="menu_buffet_normal.php">NORMAL</a>
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-4">
                        <div class="headline-font title-med white-text">TOURIST</div>
                    </div>
                    <div class="col-md-12 col-xs-12">
                        <img src="images/aka/menu/line-2.png" alt="" loading="lazy">
                    </div>
                </div>
            </div>
                    ...
                    <div class="tab-style1">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <ul class="nav nav-tabs nav-tabs-light text-center image-tab">
                                    <li class="active menu-thumb-buffet"><a href="#tab_sec1" data-toggle="tab"><p>RED BUFFET</p><img src="images/2025/tourist/button_tourist_red_225x90_01.png" alt="" loading="lazy"></a></li>
                                    <li class="menu-thumb-buffet"><a href="#tab_sec2" data-toggle="tab"><p>SILVER BUFFET</p><img src="images/2025/tourist/button_tourist_silver_225x90_02.png" alt="" loading="lazy"></a></li>
                                    <li class="menu-thumb-buffet"><a href="#tab_sec3" data-toggle="tab"><p>GOLD BUFFET</p><img src="images/2025/tourist/button_tourist_gold_225x90_03.png" alt="" loading="lazy"></a></li>
                                    <li class="menu-thumb-buffet"><a href="#tab_sec4" data-toggle="tab"><p>PLATINUM BUFFET</p><img src="images/2025/tourist/button_tourist_platinum_225x90_04.png" alt="" loading="lazy"></a></li>
                                </ul>
                                <!-- tab end navigation -->
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane med-text fade in active" id="tab_sec1">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet399-desktop">
                                        <img src="images/2025/tourist/WEB_Tourist_RED.jpg" alt="" loading="lazy">
                                    </div>
                                    <div class="col-md-12 text-center buffet399-mobile">
                                        <img src="images/2025/tourist/MOBILE_Tourist_RED.jpg" alt="" loading="lazy">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
                            ...
                            <div class="tab-pane fade in" id="tab_sec2">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet499-desktop">
                                        <img src="images/2025/tourist/WEB_Tourist_SILVER.jpg" alt="" loading="lazy">
                                    </div>
                                    <div class="col-md-12 text-center buffet499-mobile">
                                        <img src="images/2025/tourist/MOBILE_Tourist_SILVER.jpg" alt="" loading="lazy">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
                            ...
                            <div class="tab-pane fade in" id="tab_sec3">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet499-desktop">
                                        <img src="images/2025/tourist/WEB_Tourist_GOLD.jpg" alt="" loading="lazy">
                                    </div>
                                    <div class="col-md-12 text-center buffet499-mobile">
                                        <img src="images/2025/tourist/MOBILE_Tourist_GOLD.jpg" alt="" loading="lazy">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
                            ...
                            <div class="tab-pane fade in" id="tab_sec4">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet499-desktop">
                                        <img src="images/2025/tourist/WEB_Tourist_PLATINUM.jpg" alt="" loading="lazy">
                                    </div>
                                    <div class="col-md-12 text-center buffet499-mobile">
                                        <img src="images/2025/tourist/MOBILE_Tourist_PLATINUM.jpg" alt="" loading="lazy">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
