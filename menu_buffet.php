        ...
        <div class="container">
            ...
            <div class="row menu-header">
                <div class="col-md-5 col-xs-5">
                    <div class="headline-font title-med white-text">AKA Normal</div>
                </div>
                ...
                <div class="col-md-5 col-xs-5">
                    <div class="headline-font title-med gray-text">
                        <a href="menu_buffet_newworld.php">AKA New World</a>
                    </div>
                </div>
                    ...
                    <div class="tab-style1">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <ul class="nav nav-tabs nav-tabs-light text-center image-tab">
                                    <li class="active menu-thumb-buffet"><a href="#tab_sec1" data-toggle="tab"><p>RED BUFFET</p><img src="images/2024/update/normal/Normal_button_tier_225x90_01.png" alt=""></a></li>
                                    <li class="menu-thumb-buffet"><a href="#tab_sec2" data-toggle="tab"><p>SILVER BUFFET</p><img src="images/2024/update/normal/Normal_button_tier_225x90_02.png" alt=""></a></li>
                                    <li class="menu-thumb-buffet"><a href="#tab_sec3" data-toggle="tab"><p>GOLD BUFFET</p><img src="images/2024/update/normal/Normal_button_tier_225x90_03.png" alt=""></a></li>
                                    <li class="menu-thumb-buffet"><a href="#tab_sec4" data-toggle="tab"><p>PLATINUM BUFFET</p><img src="images/2024/update/normal/Normal_button_tier_225x90_04.png" alt=""></a></li>
                                </ul>
                                <!-- tab end navigation -->
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane med-text fade in active" id="tab_sec1">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet399-desktop">
                                        <img src="images/2024/update/normal/Web_Normal_339+.jpg" alt="">
                                    </div>
                                    <div class="col-md-12 text-center buffet399-mobile">
                                        <img src="images/2024/update/normal/Mobile_Normal_339+.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
                            ...
                            <div class="tab-pane fade in" id="tab_sec2">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet499-desktop">
                                        <img src="images/2024/update/normal/Web_Normal_449+.jpg" alt="">
                                    </div>
                                    <div class="col-md-12 text-center buffet499-mobile">
                                        <img src="images/2024/update/normal/Mobile_Normal_449+.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
                            ...
                            <div class="tab-pane fade in" id="tab_sec3">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet499-desktop">
                                        <img src="images/2024/update/normal/Web_Normal_559+.jpg" alt="">
                                    </div>
                                    <div class="col-md-12 text-center buffet499-mobile">
                                        <img src="images/2024/update/normal/Mobile_Normal_559+.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
                            ...
                            <div class="tab-pane fade in" id="tab_sec4">
                                <div class="row">
                                    <div class="col-md-12 text-center buffet499-desktop">
                                        <img src="images/2024/update/normal/Web_Normal_669+.jpg" alt="">
                                    </div>
                                    <div class="col-md-12 text-center buffet499-mobile">
                                        <img src="images/2024/update/normal/Mobile_Normal_669+.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- end tab content -->
